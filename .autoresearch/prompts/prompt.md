...
- Plan in checklist order from active `.autoresearch/store/search_plan.md` (use `.autoresearch/prompts/search_plan.md` as reference template).
- Update `.autoresearch/store/search_plan.md` in append-only style; preserve prior accumulated findings and add to them.
...
- In `search_plan.md`, enumerate concrete candidate values per axis (not only generic ranges).
- Mirror the output structure in `search_plan_human.md`.
...
5. `.autoresearch/store/search_plan_report.md`
